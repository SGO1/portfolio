...
function renderValidDropdown() {
  const { container, getByTestId } = render(<NavDropdown />);
  // Load css
...
describe("Check properties", () => {
  test("Props are being validated", async () => {
    ...
    // Act
    render(<NavDropdown onPreview={"a"} onEdit={"b"} onClone={"c"} onDelete={"d"} />);
  ...
  test("Props have default value", async () => {
    ...
    const { getByTestId } = render(<NavDropdown />);
...
describe("Check behavior", () => {
  test("Prop onPreview works", async () => {
    ...
    let clicked = false;
    const { getByTestId } = render(<NavDropdown onPreview={() => (clicked = true)} />);
    // -- open the dropdown
    const menuButton = getByTestId("menuButton");
    fireEvent.click(menuButton);
  ...
  test("Prop onEdit works", async () => {
    // Arrange: define a variable that will be set to true when the button is clicked
    let clicked = false;
    const { getByTestId } = render(<NavDropdown onEdit={() => (clicked = true)} />);
    // -- open the dropdown
    const menuButton = getByTestId("menuButton");
    fireEvent.click(menuButton);
  ...
  test("Prop onClone works", async () => {
    // Arrange: define a variable that will be set to true when the button is clicked
    let clicked = false;
    const { getByTestId } = render(<NavDropdown onClone={() => (clicked = true)} />);
    // -- open the dropdown
    const menuButton = getByTestId("menuButton");
    fireEvent.click(menuButton);
  ...
  test("Prop oneDelete works", async () => {
    ...
    const { getByTestId } = render(<NavDropdown onDelete={() => (clicked = true)} />);
    // Open the dropdown
    const menuButton = getByTestId("menuButton");
    fireEvent.click(menuButton);
